...
export const Frame = () => {
  ...
  return (
    <div className="flex flex-col w-[1375px] items-start gap-2.5 p-5 absolute top-[193px] left-[30px] bg-white rounded-2xl border-[0.5px] border-solid border-[#cbcbcb] shadow-[0px_0px_15px_#00000008]">
      {labs.length === 0 ? (
