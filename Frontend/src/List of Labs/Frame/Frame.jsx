...
export const Frame = () => {
  return (
    <div className="flex flex-col w-[1630px] items-start gap-5 absolute top-[155px] left-[40px] overflow-y-scroll">
      ...
      <div className="flex flex-col h-[139px] items-center justify-center gap-2.5 p-2.5 relative self-stretch w-full">
      ...
      <div className="flex items-center justify-between relative self-stretch left-[20px] w-[1570px] flex-[0_0_auto]">
        ...
        <p className="w-fit mt-[-1.00px] font-normal text-[#a1a1a1] text-sm leading-[normal] relative [font-family:'Nunito_Sans',Helvetica] tracking-[0]">
